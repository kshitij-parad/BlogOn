                  ...
                  <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                    <img src="../Images/avatar.jpg"alt="" class="avatar">
                      ...
                      <form method="post" action="editprofile.php">
                        ...
                        echo '<a href="editprofile.php?username='.$username.'"><button type="button" class="btn mt-5 fa fa-edit" id="edit" ></button></a>' ;
                      ?>
                  ...
                  <div class="mb-5">
                    ...
                    <div class="p-4" style="background-color: #f8f9fa;">
                      ...
                      <form action=" " id='contact' method="POST">
                        ...
                        <input class=" col-lg-10 formfield"  id='almn' value="<?php echo $proff; ?>" disabled/>
                        <br>
                        
                        <!--?php echo "<a href='editprofile.php?username='.$username.'><button type='submit' class='btn mt-5 fa fa-edit' name='edit' id='edit' ></button></a> ";?-->
